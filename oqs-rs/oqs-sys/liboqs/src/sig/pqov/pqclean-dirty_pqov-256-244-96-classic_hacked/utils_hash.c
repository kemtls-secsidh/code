...
int PQCLEAN_PQOV25624496CLASSIC_HACKED_hash_ctx_copy( hash_ctx * nctx , const hash_ctx * octx )
{
...
int PQCLEAN_PQOV25624496CLASSIC_HACKED_hash_final_digest( unsigned char *out , unsigned outlen , hash_ctx * ctx )
{
