...
void gf16v_mul_scalar_sse( uint8_t * a, uint8_t gf16_b , unsigned _num_byte ) {
	...
	//__m128i ml = _mm_load_si128( (__m128i*) (PQCLEAN_PQOV25624496CLASSIC_HACKED___gf16_mul + 32*b) );
...
void gf256v_mul_scalar_sse( uint8_t * a, uint8_t _b , unsigned _num_byte ) {
	//unsigned b = _b;
	//__m128i ml = _mm_load_si128( (__m128i*) (PQCLEAN_PQOV25624496CLASSIC_HACKED___gf256_mul + 32*b) );
	//__m128i mh = _mm_load_si128( (__m128i*) (PQCLEAN_PQOV25624496CLASSIC_HACKED___gf256_mul + 32*b + 16) );
...
void gf16v_generate_multab_16_sse( __m128i *multabs , __m128i a , unsigned len )
{
    ...
    __m128i bx1 = a;
    __m128i bx2 = _mm_shuffle_epi8( _mm_load_si128((__m128i const *) (PQCLEAN_PQOV25624496CLASSIC_HACKED___gf16_mulbase + 32 ))   ,bx1);
    __m128i bx4 = _mm_shuffle_epi8( _mm_load_si128((__m128i const *) (PQCLEAN_PQOV25624496CLASSIC_HACKED___gf16_mulbase + 32*2 )) ,bx1);
    __m128i bx8 = _mm_shuffle_epi8( _mm_load_si128((__m128i const *) (PQCLEAN_PQOV25624496CLASSIC_HACKED___gf16_mulbase + 32*3 )) ,bx1);
...
void gf256v_generate_multab_16_sse( __m128i *multabs , __m128i a , unsigned len )
{
    ...
    __m128i bx1 = a;
    __m128i bx2 =  _mm_shuffle_epi8( _mm_load_si128((__m128i const *) (PQCLEAN_PQOV25624496CLASSIC_HACKED___gf256_mulbase + 32*1   ))  ,a_lo)
                 ^ _mm_shuffle_epi8( _mm_load_si128((__m128i const *) (PQCLEAN_PQOV25624496CLASSIC_HACKED___gf256_mulbase + 32*1+16))  ,a_hi);
    __m128i bx4 =  _mm_shuffle_epi8( _mm_load_si128((__m128i const *) (PQCLEAN_PQOV25624496CLASSIC_HACKED___gf256_mulbase + 32*2   ))  ,a_lo)
                 ^ _mm_shuffle_epi8( _mm_load_si128((__m128i const *) (PQCLEAN_PQOV25624496CLASSIC_HACKED___gf256_mulbase + 32*2+16))  ,a_hi);
    __m128i bx8 =  _mm_shuffle_epi8( _mm_load_si128((__m128i const *) (PQCLEAN_PQOV25624496CLASSIC_HACKED___gf256_mulbase + 32*3   ))  ,a_lo)
                 ^ _mm_shuffle_epi8( _mm_load_si128((__m128i const *) (PQCLEAN_PQOV25624496CLASSIC_HACKED___gf256_mulbase + 32*3+16))  ,a_hi);

    __m128i bx10 =  _mm_shuffle_epi8( _mm_load_si128((__m128i const *) (PQCLEAN_PQOV25624496CLASSIC_HACKED___gf256_mulbase + 32*4   ))  ,a_lo)
                  ^ _mm_shuffle_epi8( _mm_load_si128((__m128i const *) (PQCLEAN_PQOV25624496CLASSIC_HACKED___gf256_mulbase + 32*4+16))  ,a_hi);
    __m128i bx20 =  _mm_shuffle_epi8( _mm_load_si128((__m128i const *) (PQCLEAN_PQOV25624496CLASSIC_HACKED___gf256_mulbase + 32*5   ))  ,a_lo)
                  ^ _mm_shuffle_epi8( _mm_load_si128((__m128i const *) (PQCLEAN_PQOV25624496CLASSIC_HACKED___gf256_mulbase + 32*5+16))  ,a_hi);
    __m128i bx40 =  _mm_shuffle_epi8( _mm_load_si128((__m128i const *) (PQCLEAN_PQOV25624496CLASSIC_HACKED___gf256_mulbase + 32*6   ))  ,a_lo)
                  ^ _mm_shuffle_epi8( _mm_load_si128((__m128i const *) (PQCLEAN_PQOV25624496CLASSIC_HACKED___gf256_mulbase + 32*6+16))  ,a_hi);
    __m128i bx80 =  _mm_shuffle_epi8( _mm_load_si128((__m128i const *) (PQCLEAN_PQOV25624496CLASSIC_HACKED___gf256_mulbase + 32*7   ))  ,a_lo)
                  ^ _mm_shuffle_epi8( _mm_load_si128((__m128i const *) (PQCLEAN_PQOV25624496CLASSIC_HACKED___gf256_mulbase + 32*7+16))  ,a_hi);
