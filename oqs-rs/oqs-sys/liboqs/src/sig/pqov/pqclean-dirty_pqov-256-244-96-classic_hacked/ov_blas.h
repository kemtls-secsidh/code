...
#define gfmat_prod      PQCLEAN_PQOV25624496CLASSIC_HACKED_gf256mat_prod

#define batch_trimat_madd    PQCLEAN_PQOV25624496CLASSIC_HACKED_batch_trimat_madd_gf256
#define batch_trimatTr_madd  PQCLEAN_PQOV25624496CLASSIC_HACKED_batch_trimatTr_madd_gf256
#define batch_2trimat_madd   PQCLEAN_PQOV25624496CLASSIC_HACKED_batch_2trimat_madd_gf256
#define batch_matTr_madd     batch_matTr_madd_gf256
#define batch_upper_matTr_x_mat     PQCLEAN_PQOV25624496CLASSIC_HACKED_batch_upper_matTr_x_mat_gf256

  #if defined(_MUL_WITH_MULTAB_)
  #define gfv_generate_multabs   gf256v_generate_multabs
  #define gfmat_prod_multab      PQCLEAN_PQOV25624496CLASSIC_HACKED_gf256mat_prod_multab
  #define gfv_madd_multab        gf256v_madd_multab
  #define batch_trimat_madd_multab    PQCLEAN_PQOV25624496CLASSIC_HACKED_batch_trimat_madd_multab_gf256
  #define batch_trimatTr_madd_multab  PQCLEAN_PQOV25624496CLASSIC_HACKED_batch_trimatTr_madd_multab_gf256
  #define batch_2trimat_madd_multab   PQCLEAN_PQOV25624496CLASSIC_HACKED_batch_2trimat_madd_multab_gf256
  #define batch_matTr_madd_multab     batch_matTr_madd_multab_gf256
  #define batch_upper_matTr_x_mat_multab     PQCLEAN_PQOV25624496CLASSIC_HACKED_batch_upper_matTr_x_mat_multab_gf256
  #define batch_quad_trimat_eval_multab PQCLEAN_PQOV25624496CLASSIC_HACKED_batch_quad_trimat_eval_multab_gf256
  #endif

// TODO: this should be cleaner
#if defined( _BLAS_M4F_)
#include "blas_matrix_m4f.h"
#define batch_quad_trimat_eval PQCLEAN_PQOV25624496CLASSIC_HACKED_batch_quad_trimat_eval_gf256_m4f
#else
#define batch_quad_trimat_eval PQCLEAN_PQOV25624496CLASSIC_HACKED_batch_quad_trimat_eval_gf256
#endif


#define gfmat_inv       PQCLEAN_PQOV25624496CLASSIC_HACKED_gf256mat_inv
