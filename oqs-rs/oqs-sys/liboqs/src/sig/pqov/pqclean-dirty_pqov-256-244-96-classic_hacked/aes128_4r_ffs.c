...
******************************************************************************/
void PQCLEAN_PQOV25624496CLASSIC_HACKED_aes128_keyschedule_ffs_lut(uint32_t* rkeys_ffs, const unsigned char* key){
...
void PQCLEAN_PQOV25624496CLASSIC_HACKED_aes128_4r_keyschedule_ffs_lut(uint32_t* rkeys_ffs, const unsigned char* key){
        uint32_t t0, t1, t2, tmp;
        uint32_t rkeys[20];
        // key schedule in the classical representation
        rkeys[0] = LE_LOAD_32(key);
...
* ptext parameters.
******************************************************************************/
void PQCLEAN_PQOV25624496CLASSIC_HACKED_aes128_encrypt_ffs(unsigned char* ctext0, unsigned char * ctext1,
...
void PQCLEAN_PQOV25624496CLASSIC_HACKED_aes128_4r_encrypt_ffs(unsigned char* ctext0, unsigned char * ctext1,
                                        const unsigned char* ptext0, const unsigned char* ptext1,
                                        const uint32_t* rkeys_ffs) {
        uint32_t state[8];                                      // 256-bit internal state
        packing(state, ptext0, ptext1);         // packs into bitsliced representation
