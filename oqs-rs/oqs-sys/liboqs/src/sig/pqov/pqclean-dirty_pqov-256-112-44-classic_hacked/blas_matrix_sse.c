...
void PQCLEAN_PQOV25611244CLASSIC_HACKED_gf16mat_prod_multab_sse( uint8_t * c , const uint8_t * matA , unsigned matA_vec_byte , unsigned matA_n_vec , const uint8_t * multab_b )
{
...
void PQCLEAN_PQOV25611244CLASSIC_HACKED_gf16mat_prod_sse( uint8_t * c , const uint8_t * matA , unsigned matA_vec_byte , unsigned matA_n_vec , const uint8_t * b )
{
...
void PQCLEAN_PQOV25611244CLASSIC_HACKED_gf256mat_prod_multab_sse( uint8_t * c , const uint8_t * matA , unsigned matA_vec_byte , unsigned matA_n_vec , const uint8_t * multab_b )
{
    const __m128i * multabs = (const __m128i*)multab_b;
    PQCLEAN_PQOV25611244CLASSIC_HACKED_gf256v_set_zero( c , matA_vec_byte );
...
void PQCLEAN_PQOV25611244CLASSIC_HACKED_gf256mat_prod_sse( uint8_t * c , const uint8_t * matA , unsigned matA_vec_byte , unsigned matA_n_vec , const uint8_t * b ) {
...
unsigned PQCLEAN_PQOV25611244CLASSIC_HACKED_gf16mat_inv_32x32_sse( uint8_t * inv_a , const uint8_t * mat_a )
{
	//const unsigned h=32;
...
unsigned PQCLEAN_PQOV25611244CLASSIC_HACKED_gf16mat_inv_sse(uint8_t *inv_a, const uint8_t *a , unsigned h )
{
    if( 32==h ) return PQCLEAN_PQOV25611244CLASSIC_HACKED_gf16mat_inv_32x32_sse( inv_a , a );
...
unsigned PQCLEAN_PQOV25611244CLASSIC_HACKED_gf16mat_solve_linear_eq_32x32_sse( uint8_t * sol , const uint8_t * inp_mat , const uint8_t * c_terms )
{
	//const unsigned n = 32;

	uint8_t mat[ 32*16 ] __attribute__((aligned(32)));
	unsigned r8 = PQCLEAN_PQOV25611244CLASSIC_HACKED_gf16mat_inv_32x32_sse( mat , inp_mat );
	PQCLEAN_PQOV25611244CLASSIC_HACKED_gf16mat_prod_sse( sol , mat , 16 , 32 , c_terms );

	PQCLEAN_PQOV25611244CLASSIC_HACKED_gf256v_set_zero( mat , 32*16 );
	return r8;
}
...
unsigned PQCLEAN_PQOV25611244CLASSIC_HACKED_gf256mat_inv_32x32_sse( uint8_t * inv_a , const uint8_t * mat_a )
{
	const unsigned h = 32;
	...
	PQCLEAN_PQOV25611244CLASSIC_HACKED_gf256v_set_zero( mat , h*vec_len );
	return r;
}

unsigned PQCLEAN_PQOV25611244CLASSIC_HACKED_gf256mat_solve_linear_eq_48x48_sse( uint8_t * sol , const uint8_t * mat_a , const uint8_t * c_terms )
{
	const unsigned h = 48;
	...
	PQCLEAN_PQOV25611244CLASSIC_HACKED_gf256mat_prod_sse( sol , mat , h , h , c_terms );
...
unsigned PQCLEAN_PQOV25611244CLASSIC_HACKED_gf256mat_inv_36x36_sse( uint8_t * inv_a , const uint8_t * mat_a )
{
	const unsigned h = 36;
...
unsigned PQCLEAN_PQOV25611244CLASSIC_HACKED_gf256mat_inv_sse( uint8_t * inv_a , const uint8_t * a , unsigned h )
{
    if( 32 == h ) return PQCLEAN_PQOV25611244CLASSIC_HACKED_gf256mat_inv_32x32_sse(inv_a,a);
    if( 36 == h ) return PQCLEAN_PQOV25611244CLASSIC_HACKED_gf256mat_inv_36x36_sse(inv_a,a);

//    return PQCLEAN_PQOV25611244CLASSIC_HACKED_gf256mat_inv_ref(inv_a,a,h);
...
unsigned PQCLEAN_PQOV25611244CLASSIC_HACKED_gf256mat_solve_linear_eq_64x64_sse( uint8_t * sol , const uint8_t * mat_a , const uint8_t * c_terms )
{
	const unsigned h = 64;
