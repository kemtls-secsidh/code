...
{
	return _mm_shuffle_epi8(_mm_load_si128((__m128i const *) PQCLEAN_PQOV25611244CLASSIC_HACKED___gf16_squ ),a);
}

static inline __m128i tbl_gf16_inv( __m128i a )
{
	return _mm_shuffle_epi8(_mm_load_si128((__m128i const *) PQCLEAN_PQOV25611244CLASSIC_HACKED___gf16_inv ),a);
}
...
{
	return _mm_shuffle_epi8( _mm_load_si128((__m128i const *) (PQCLEAN_PQOV25611244CLASSIC_HACKED___gf16_mul+  ((unsigned)a)*32 )) ,b);
}
...
static inline __m128i tbl_gf16_multab( uint8_t b )
{
    ...
    __m128i tab0 = _mm_load_si128((__m128i const *) (PQCLEAN_PQOV25611244CLASSIC_HACKED___gf16_mulbase + 32*0));
    __m128i tab1 = _mm_load_si128((__m128i const *) (PQCLEAN_PQOV25611244CLASSIC_HACKED___gf16_mulbase + 32*1));
    __m128i tab2 = _mm_load_si128((__m128i const *) (PQCLEAN_PQOV25611244CLASSIC_HACKED___gf16_mulbase + 32*2));
    __m128i tab3 = _mm_load_si128((__m128i const *) (PQCLEAN_PQOV25611244CLASSIC_HACKED___gf16_mulbase + 32*3));
    ...
    return (_mm_load_si128((__m128i const *) (PQCLEAN_PQOV25611244CLASSIC_HACKED___gf16_mulbase + 32*0))&_mm_cmpeq_epi8(mask,bx1&mask))
         ^ (_mm_load_si128((__m128i const *) (PQCLEAN_PQOV25611244CLASSIC_HACKED___gf16_mulbase + 32*1))&_mm_cmpeq_epi8(mask,_mm_srli_epi16(bx1,1)&mask))
         ^ (_mm_load_si128((__m128i const *) (PQCLEAN_PQOV25611244CLASSIC_HACKED___gf16_mulbase + 32*2))&_mm_cmpeq_epi8(mask,_mm_srli_epi16(bx1,2)&mask))
         ^ (_mm_load_si128((__m128i const *) (PQCLEAN_PQOV25611244CLASSIC_HACKED___gf16_mulbase + 32*3))&_mm_cmpeq_epi8(mask,_mm_srli_epi16(bx1,3)&mask));
#endif
}
...
{
	return _mm_shuffle_epi8(_mm_load_si128((__m128i const *) PQCLEAN_PQOV25611244CLASSIC_HACKED___gf16_log ),a);
}

static inline __m128i tbl_gf16_exp( __m128i a )
{
	return _mm_shuffle_epi8(_mm_load_si128((__m128i const *) PQCLEAN_PQOV25611244CLASSIC_HACKED___gf16_exp ),a);
}
...
{
	__m128i mask_f = _mm_set1_epi8( 0xf );
	__m128i log_16 = _mm_load_si128((__m128i const *) PQCLEAN_PQOV25611244CLASSIC_HACKED___gf16_log);
	__m128i exp_16 = _mm_load_si128((__m128i const *) PQCLEAN_PQOV25611244CLASSIC_HACKED___gf16_exp);
...
{
	__m128i mask_f = _mm_set1_epi8( 0xf );
	__m128i tab_l = _mm_load_si128((__m128i const *) (PQCLEAN_PQOV25611244CLASSIC_HACKED___gf256_mul+  ((unsigned)a)*32 ));
	__m128i tab_h = _mm_load_si128((__m128i const *) (PQCLEAN_PQOV25611244CLASSIC_HACKED___gf256_mul+  ((unsigned)a)*32 + 16 ));
...
{
    __m128i mask_f = _mm_set1_epi8( 0xf );
    __m128i tab_l = _mm_load_si128((__m128i const *) (PQCLEAN_PQOV25611244CLASSIC_HACKED___gf256_squ) );
    __m128i tab_h = _mm_load_si128((__m128i const *) (PQCLEAN_PQOV25611244CLASSIC_HACKED___gf256_squ+16) );
...
__m128ix2_t tbl_gf256_multab( uint8_t b )
{
    ...
    __m128i m0 = _mm_load_si128((__m128i const *) (PQCLEAN_PQOV25611244CLASSIC_HACKED___gf256_mulbase + 32*0));
    __m128i m1 = _mm_load_si128((__m128i const *) (PQCLEAN_PQOV25611244CLASSIC_HACKED___gf256_mulbase + 32*0+16));
    __m128i bi = _mm_cmpeq_epi8(mask,bx&mask);
    __m128ix2_t r;
    r.v0 = m0&bi;
    r.v1 = m1&bi;
    for(unsigned i=1;i<8;i++) {
        m0 = _mm_load_si128((__m128i const *) (PQCLEAN_PQOV25611244CLASSIC_HACKED___gf256_mulbase + 32*i));
        m1 = _mm_load_si128((__m128i const *) (PQCLEAN_PQOV25611244CLASSIC_HACKED___gf256_mulbase + 32*i+16));
