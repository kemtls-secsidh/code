...
void gf16v_generate_multab_16_avx2( __m256i *multabs , __m128i a , unsigned len )
{
    ...
    __m256i bx2 = _mm256_shuffle_epi8( _mm256_load_si256((__m256i const *) (PQCLEAN_PQOV25611244CLASSIC_HACKED___gf16_mulbase + 32 ))   , bx1 );
    __m256i bx4 = _mm256_shuffle_epi8( _mm256_load_si256((__m256i const *) (PQCLEAN_PQOV25611244CLASSIC_HACKED___gf16_mulbase + 32*2 )) , bx1 );
    __m256i bx8 = _mm256_shuffle_epi8( _mm256_load_si256((__m256i const *) (PQCLEAN_PQOV25611244CLASSIC_HACKED___gf16_mulbase + 32*3 )) , bx1 );
...
{
    __m256i tab0 = _mm256_load_si256((__m256i const *) (PQCLEAN_PQOV25611244CLASSIC_HACKED___gf256_mulbase_avx + 32*0));
    __m256i tab1 = _mm256_load_si256((__m256i const *) (PQCLEAN_PQOV25611244CLASSIC_HACKED___gf256_mulbase_avx + 32*1));
    __m256i tab2 = _mm256_load_si256((__m256i const *) (PQCLEAN_PQOV25611244CLASSIC_HACKED___gf256_mulbase_avx + 32*2));
    __m256i tab3 = _mm256_load_si256((__m256i const *) (PQCLEAN_PQOV25611244CLASSIC_HACKED___gf256_mulbase_avx + 32*3));
    __m256i tab4 = _mm256_load_si256((__m256i const *) (PQCLEAN_PQOV25611244CLASSIC_HACKED___gf256_mulbase_avx + 32*4));
    __m256i tab5 = _mm256_load_si256((__m256i const *) (PQCLEAN_PQOV25611244CLASSIC_HACKED___gf256_mulbase_avx + 32*5));
    __m256i tab6 = _mm256_load_si256((__m256i const *) (PQCLEAN_PQOV25611244CLASSIC_HACKED___gf256_mulbase_avx + 32*6));
    __m256i tab7 = _mm256_load_si256((__m256i const *) (PQCLEAN_PQOV25611244CLASSIC_HACKED___gf256_mulbase_avx + 32*7));
