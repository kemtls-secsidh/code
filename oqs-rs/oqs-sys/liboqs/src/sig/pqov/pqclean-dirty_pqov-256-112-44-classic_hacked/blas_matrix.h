...
///
void PQCLEAN_PQOV25611244CLASSIC_HACKED_gf256mat_prod_multab(uint8_t *c, const uint8_t *matA, unsigned n_A_vec_byte, unsigned n_A_width, const uint8_t *multab_b);
...
/// @return   1(true) if success. 0(false) if the matrix is singular.
///
unsigned PQCLEAN_PQOV25611244CLASSIC_HACKED_gf256mat_gaussian_elim(uint8_t *sq_col_mat_a , uint8_t *constant, unsigned len);
...
/// @param[in]           len       - the height of the matrix a, i.e., the number of row vectors.
///
void PQCLEAN_PQOV25611244CLASSIC_HACKED_gf256mat_back_substitute( uint8_t *constant, const uint8_t *sq_row_mat_a, unsigned len);
