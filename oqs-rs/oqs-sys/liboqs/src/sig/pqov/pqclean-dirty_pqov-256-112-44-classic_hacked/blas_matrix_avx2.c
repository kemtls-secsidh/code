...
void PQCLEAN_PQOV25611244CLASSIC_HACKED_gf16mat_prod_multab_avx2( uint8_t * c , const uint8_t * matA , unsigned matA_vec_byte , unsigned matA_n_vec , const uint8_t * multab_b )
{
    ...
    PQCLEAN_PQOV25611244CLASSIC_HACKED_gf256v_set_zero( c , matA_vec_byte );
...
void PQCLEAN_PQOV25611244CLASSIC_HACKED_gf16mat_prod_avx2( uint8_t * c , const uint8_t * matA , unsigned matA_vec_byte , unsigned matA_n_vec , const uint8_t * b )
{
...
static void PQCLEAN_PQOV25611244CLASSIC_HACKED_gf256mat_prod_multab_1ymm_avx2( uint8_t * c , const uint8_t * matA , unsigned matA_vec_byte , unsigned matA_n_vec , const __m256i * multabs ) {
...
static void PQCLEAN_PQOV25611244CLASSIC_HACKED_gf256mat_prod_multab_2ymm_avx2( uint8_t * c , const uint8_t * matA , unsigned matA_vec_byte , unsigned matA_n_vec , const __m256i * multabs ) {
...
static void PQCLEAN_PQOV25611244CLASSIC_HACKED_gf256mat_prod_multab_3ymm_avx2( uint8_t * c , const uint8_t * matA , unsigned matA_vec_byte , unsigned matA_n_vec , const __m256i * multabs ) {
	__m256i tmp0 = _mm256_setzero_si256();
	__m256i tmp1 = _mm256_setzero_si256();
...
static void PQCLEAN_PQOV25611244CLASSIC_HACKED_gf256mat_prod_multab_small_avx2( uint8_t * c , const uint8_t * matA , unsigned matA_vec_byte , unsigned matA_n_vec , const __m256i * multabs ) {
	// XXX: if(matA_vec_byte <16 ) exit(-1);
#if 1
// faster
    if     (matA_vec_byte <= 32) { PQCLEAN_PQOV25611244CLASSIC_HACKED_gf256mat_prod_multab_1ymm_avx2(c,matA,matA_vec_byte,matA_n_vec,multabs); return; }
    else if(matA_vec_byte <= 64) { PQCLEAN_PQOV25611244CLASSIC_HACKED_gf256mat_prod_multab_2ymm_avx2(c,matA,matA_vec_byte,matA_n_vec,multabs); return; }
    else {                         PQCLEAN_PQOV25611244CLASSIC_HACKED_gf256mat_prod_multab_3ymm_avx2(c,matA,matA_vec_byte,matA_n_vec,multabs); return; }
#else
    if     (matA_vec_byte > 64) { PQCLEAN_PQOV25611244CLASSIC_HACKED_gf256mat_prod_multab_3ymm_avx2(c,matA,matA_vec_byte,matA_n_vec,multabs); return; }
	else if(matA_vec_byte > 32) { PQCLEAN_PQOV25611244CLASSIC_HACKED_gf256mat_prod_multab_2ymm_avx2(c,matA,matA_vec_byte,matA_n_vec,multabs); return; }
    else {                        PQCLEAN_PQOV25611244CLASSIC_HACKED_gf256mat_prod_multab_1ymm_avx2(c,matA,matA_vec_byte,matA_n_vec,multabs); return; }
#endif
}

void PQCLEAN_PQOV25611244CLASSIC_HACKED_gf256mat_prod_multab_avx2( uint8_t * c , const uint8_t * matA , unsigned matA_vec_byte , unsigned matA_n_vec , const uint8_t * multab_b )
{
    const __m256i *multabs = (const __m256i *)multab_b;
	if( 96>=matA_vec_byte ) { PQCLEAN_PQOV25611244CLASSIC_HACKED_gf256mat_prod_multab_small_avx2(c,matA,matA_vec_byte,matA_n_vec,multabs); return; }
...
#if 1
static
void PQCLEAN_PQOV25611244CLASSIC_HACKED_gf256mat_prod_small_avx2( uint8_t * c , const uint8_t * matA , unsigned matA_vec_byte , unsigned matA_n_vec , const uint8_t * b )
{
    __m256i multabs[96];
	...
	PQCLEAN_PQOV25611244CLASSIC_HACKED_gf256mat_prod_multab_small_avx2(c, matA, matA_vec_byte, matA_n_vec , multabs );
}
#endif

void PQCLEAN_PQOV25611244CLASSIC_HACKED_gf256mat_prod_avx2( uint8_t * c , const uint8_t * matA , unsigned matA_vec_byte , unsigned matA_n_vec , const uint8_t * b )
{
	if( (96>=matA_vec_byte)&&(96>=matA_n_vec) ) { PQCLEAN_PQOV25611244CLASSIC_HACKED_gf256mat_prod_small_avx2(c,matA,matA_vec_byte,matA_n_vec,b); return; }
...
unsigned PQCLEAN_PQOV25611244CLASSIC_HACKED_gf16mat_inv_32x32_avx2(uint8_t *inv_a, const uint8_t *a )
{
	...
	PQCLEAN_PQOV25611244CLASSIC_HACKED_gf256v_set_zero( mat , 32*32 );
	return r8;
}


unsigned PQCLEAN_PQOV25611244CLASSIC_HACKED_gf16mat_inv_16x16_avx2(uint8_t *inv_a, const uint8_t *a )
{
...
unsigned PQCLEAN_PQOV25611244CLASSIC_HACKED_gf16mat_inv_avx2(uint8_t *inv_a, const uint8_t *a , unsigned h )
{
    if( 32==h ) return PQCLEAN_PQOV25611244CLASSIC_HACKED_gf16mat_inv_32x32_avx2( inv_a , a );
	if( 16==h ) return PQCLEAN_PQOV25611244CLASSIC_HACKED_gf16mat_inv_16x16_avx2( inv_a , a );
    // assert( h <= 64 );
#define MAX_H  64
...
#undef MAX_H
    ...
    for (unsigned i = 0; i < h; i++) {
        ...
        PQCLEAN_PQOV25611244CLASSIC_HACKED_gf256v_set_zero(ai, w_byte );
...
unsigned PQCLEAN_PQOV25611244CLASSIC_HACKED_gf16mat_gaussian_elim_avx2(uint8_t *sqmat_a , uint8_t *constant, unsigned len)
{
    if(64 == len ) {
...
void PQCLEAN_PQOV25611244CLASSIC_HACKED_gf16mat_back_substitute_avx2( uint8_t *constant, const uint8_t *sq_row_mat_a, unsigned len)
{
    if(64==len) {
...
unsigned PQCLEAN_PQOV25611244CLASSIC_HACKED_gf256mat_inv_avx2(uint8_t *inv_a, const uint8_t *mat_a , unsigned h )
{
	// assert( h <= 96 );
...
unsigned PQCLEAN_PQOV25611244CLASSIC_HACKED_gf256mat_gaussian_elim_avx2(uint8_t *sqmat_a , uint8_t *constant, unsigned len)
{
#define MAX_H  96
...
void PQCLEAN_PQOV25611244CLASSIC_HACKED_gf256mat_back_substitute_avx2( uint8_t *constant, const uint8_t *sq_row_mat_a, unsigned len)
{
