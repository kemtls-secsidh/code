...
///
void PQCLEAN_PQOV1616064CLASSIC_HACKED_gf16mat_prod_multab(uint8_t *c, const uint8_t *matA, unsigned n_A_vec_byte, unsigned n_A_width, const uint8_t *multab_b);
...
/// @return   1(true) if success. 0(false) if the matrix is singular.
///
unsigned PQCLEAN_PQOV1616064CLASSIC_HACKED_gf16mat_gaussian_elim(uint8_t *sq_col_mat_a , uint8_t *constant, unsigned len);
...
///
void PQCLEAN_PQOV1616064CLASSIC_HACKED_gf16mat_back_substitute( uint8_t *constant, const uint8_t *sq_row_mat_a, unsigned len);
...
unsigned PQCLEAN_PQOV1616064CLASSIC_HACKED_gf16mat_LDUinv(uint8_t *mat_U_AinvB, uint8_t *mat_Ainv, uint8_t *mat_CAinvB_inv, uint8_t *mat_L_C, const uint8_t *matA , unsigned mat_dim);

void PQCLEAN_PQOV1616064CLASSIC_HACKED_gf16mat_LDUinv_prod(uint8_t *c, const uint8_t *mat_U_AinvB, const uint8_t *mat_Ainv, const uint8_t *mat_CAinvB_inv, const uint8_t *mat_L_C, const uint8_t * b , unsigned veclen_byte);
