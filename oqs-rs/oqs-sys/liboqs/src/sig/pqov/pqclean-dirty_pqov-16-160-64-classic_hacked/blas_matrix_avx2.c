...
static inline
void PQCLEAN_PQOV1616064CLASSIC_HACKED_gf16mat_prod_multab_64x_avx2( uint8_t * c , const uint8_t * matA , unsigned n_ele , const __m256i * multab_b )
{
...
static void PQCLEAN_PQOV1616064CLASSIC_HACKED_gf16mat_prod_multab_32x32_avx2( uint8_t * c , const uint8_t * matA , const __m256i * multab_b )
{
	__m256i mask_f = _mm256_set1_epi8(0xf);
...
static void PQCLEAN_PQOV1616064CLASSIC_HACKED_gf16mat_prod_multab_16x16_avx2( uint8_t * c , const uint8_t * matA , const __m256i * multab_b )
{
	__m256i mask_f = _mm256_set1_epi8(0xf);
...
void PQCLEAN_PQOV1616064CLASSIC_HACKED_gf16mat_prod_multab_avx2( uint8_t * c , const uint8_t * matA , unsigned matA_vec_byte , unsigned matA_n_vec , const uint8_t * multab_b )
{
	if((32==matA_vec_byte)) { PQCLEAN_PQOV1616064CLASSIC_HACKED_gf16mat_prod_multab_64x_avx2(c,matA,matA_n_vec,(const __m256i*)multab_b); return; }
	if((16==matA_vec_byte)&&(32==matA_n_vec)) { PQCLEAN_PQOV1616064CLASSIC_HACKED_gf16mat_prod_multab_32x32_avx2(c,matA,(const __m256i*)multab_b); return; }
	if((8==matA_vec_byte) &&(16==matA_n_vec)) { PQCLEAN_PQOV1616064CLASSIC_HACKED_gf16mat_prod_multab_16x16_avx2(c,matA,(const __m256i*)multab_b); return; }

    const __m256i * multabs = (const __m256i*)multab_b;
    PQCLEAN_PQOV1616064CLASSIC_HACKED_gf256v_set_zero( c , matA_vec_byte );
...
static void PQCLEAN_PQOV1616064CLASSIC_HACKED_gf16mat_prod_64x_avx2( uint8_t * c , const uint8_t * matA , unsigned n_ele , const uint8_t * b )
{
	__m256i multabs[32];
	__m256i ci;
	...
	while( n_ele ) {
		...
		PQCLEAN_PQOV1616064CLASSIC_HACKED_gf16mat_prod_multab_64x_avx2( (uint8_t *)&ci , matA , i_ele , multabs );
		r ^= ci;
		n_ele -= i_ele;
		matA += 32*i_ele;
		b += i_ele/2;
...
static void PQCLEAN_PQOV1616064CLASSIC_HACKED_gf16mat_prod_32x32_avx2( uint8_t * c , const uint8_t * matA , const uint8_t * b )
{
	__m256i multabs[32];
	...
	PQCLEAN_PQOV1616064CLASSIC_HACKED_gf16mat_prod_multab_32x32_avx2( c , matA , multabs );
}

static void PQCLEAN_PQOV1616064CLASSIC_HACKED_gf16mat_prod_16x16_avx2( uint8_t * c , const uint8_t * matA , const uint8_t * b )
{
	__m256i multabs[16];
	uint8_t temp[16] __attribute__((aligned(16)));
	...
	PQCLEAN_PQOV1616064CLASSIC_HACKED_gf16mat_prod_multab_16x16_avx2( c , matA , multabs );
}



void PQCLEAN_PQOV1616064CLASSIC_HACKED_gf16mat_prod_avx2( uint8_t * c , const uint8_t * matA , unsigned matA_vec_byte , unsigned matA_n_vec , const uint8_t * b )
{
	if((32==matA_vec_byte)) { PQCLEAN_PQOV1616064CLASSIC_HACKED_gf16mat_prod_64x_avx2(c,matA,matA_n_vec,b); return; }
	if((16==matA_vec_byte)&&(32==matA_n_vec)) { PQCLEAN_PQOV1616064CLASSIC_HACKED_gf16mat_prod_32x32_avx2(c,matA,b); return; }
	if((8==matA_vec_byte) &&(16==matA_n_vec)) { PQCLEAN_PQOV1616064CLASSIC_HACKED_gf16mat_prod_16x16_avx2(c,matA,b); return; }
...
void PQCLEAN_PQOV1616064CLASSIC_HACKED_gf256mat_prod_multab_avx2( uint8_t * c , const uint8_t * matA , unsigned matA_vec_byte , unsigned matA_n_vec , const uint8_t * multab_b )
{
    const __m256i *multabs = (const __m256i *)multab_b;
...
void PQCLEAN_PQOV1616064CLASSIC_HACKED_gf256mat_prod_avx2( uint8_t * c , const uint8_t * matA , unsigned matA_vec_byte , unsigned matA_n_vec , const uint8_t * b )
{
...
unsigned PQCLEAN_PQOV1616064CLASSIC_HACKED_gf16mat_inv_32x32_avx2(uint8_t *inv_a, const uint8_t *a )
{
	...
	PQCLEAN_PQOV1616064CLASSIC_HACKED_gf256v_set_zero( mat , 32*32 );
	return r8;
}


unsigned PQCLEAN_PQOV1616064CLASSIC_HACKED_gf16mat_inv_16x16_avx2(uint8_t *inv_a, const uint8_t *a )
{
...
unsigned PQCLEAN_PQOV1616064CLASSIC_HACKED_gf16mat_inv_avx2(uint8_t *inv_a, const uint8_t *a , unsigned h )
{
    if( 32==h ) return PQCLEAN_PQOV1616064CLASSIC_HACKED_gf16mat_inv_32x32_avx2( inv_a , a );
	if( 16==h ) return PQCLEAN_PQOV1616064CLASSIC_HACKED_gf16mat_inv_16x16_avx2( inv_a , a );
    // assert( h <= 64 );
#define MAX_H  64
...
#undef MAX_H
    ...
    for (unsigned i = 0; i < h; i++) {
        ...
        PQCLEAN_PQOV1616064CLASSIC_HACKED_gf256v_set_zero(ai, w_byte );
...
unsigned PQCLEAN_PQOV1616064CLASSIC_HACKED_gf16mat_gaussian_elim_avx2(uint8_t *sqmat_a , uint8_t *constant, unsigned len)
{
    if(64 == len ) {
		return gf16mat_GE_64x64_avx2( sqmat_a , constant );
	} else {
#if 0
		return PQCLEAN_PQOV1616064CLASSIC_HACKED_gf16mat_gaussian_elim_ref(sqmat_a,constant,len);
#else
...
#if 0 
		PQCLEAN_PQOV1616064CLASSIC_HACKED_gf16mat_back_substitute_ref(constant,sq_row_mat_a,len);
#else
...
unsigned PQCLEAN_PQOV1616064CLASSIC_HACKED_gf256mat_inv_avx2(uint8_t *inv_a, const uint8_t *mat_a , unsigned h )
{
	// assert( h <= 96 );
...
unsigned PQCLEAN_PQOV1616064CLASSIC_HACKED_gf256mat_gaussian_elim_avx2(uint8_t *sqmat_a , uint8_t *constant, unsigned len)
{
#define MAX_H  96
