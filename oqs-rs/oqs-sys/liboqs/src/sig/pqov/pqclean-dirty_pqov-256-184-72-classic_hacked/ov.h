...
///
int PQCLEAN_PQOV25618472CLASSIC_HACKED_generate_keypair( pk_t * pk, sk_t* sk, const unsigned char *pk_seed, const unsigned char *sk_seed);
...
/// @return 0 for success. -1 otherwise.
///
int PQCLEAN_PQOV25618472CLASSIC_HACKED_sk_to_pk( pk_t * pk , const sk_t* sk );
...
/// @return 0 for success. -1 otherwise.
///
int PQCLEAN_PQOV25618472CLASSIC_HACKED_generate_keypair_pkc_skc( cpk_t * pk, csk_t* sk, const unsigned char *pk_seed , const unsigned char *sk_seed );
...
///
int PQCLEAN_PQOV25618472CLASSIC_HACKED_expand_pk( pk_t * pk , const cpk_t * cpk );
...
///
int PQCLEAN_PQOV25618472CLASSIC_HACKED_expand_pk_predicate( pk_t * pk , const cpk_t * cpk , const unsigned char *predicate);
...
///
void PQCLEAN_PQOV25618472CLASSIC_HACKED_ov_publicmap( unsigned char * z , const unsigned char *pk , const unsigned char * w );
...
/// @param[in]  w         - the input vector w.
///
void PQCLEAN_PQOV25618472CLASSIC_HACKED_ov_publicmap_pkc( unsigned char * z , const cpk_t *pk , const unsigned char * w );
