...
///
void PQCLEAN_PQOV25618472CLASSIC_HACKED_calculate_F2_P3( unsigned char * F2, unsigned char * P3, const unsigned char * P1 , const unsigned char * P2 , const unsigned char * sk );
...
/// @param[in]  sk       - O of the sk
///
void PQCLEAN_PQOV25618472CLASSIC_HACKED_calculate_F2( unsigned char * F2, const unsigned char * P1 , const unsigned char * P2 , const unsigned char * sk );
...
/// @param[in]  sk       - O of the sk
///
void PQCLEAN_PQOV25618472CLASSIC_HACKED_calculate_P3( unsigned char * P3, const unsigned char * P1 , const unsigned char * P2 , const unsigned char * sk );
