...
void PQCLEAN_PQOV25618472CLASSIC_HACKED_calculate_F2( unsigned char * F2, const unsigned char * P1 , const unsigned char * P2 , const unsigned char * sk_t1 )
{
...
void PQCLEAN_PQOV25618472CLASSIC_HACKED_ov_pkc_calculate_F_from_Q( sk_t * Fs)
{
    PQCLEAN_PQOV25618472CLASSIC_HACKED_ov_pkc_calculate_F_from_Q_m4f( Fs );
}
#else
void PQCLEAN_PQOV25618472CLASSIC_HACKED_ov_pkc_calculate_F_from_Q( sk_t * Fs)
{
    PQCLEAN_PQOV25618472CLASSIC_HACKED_calculate_F2( Fs->L , Fs->P1 , Fs->L , Fs->t1 );
}
#endif
...
void PQCLEAN_PQOV25618472CLASSIC_HACKED_calculate_F2_P3( unsigned char * F2, unsigned char * P3, const unsigned char * P1 , const unsigned char * P2 , const unsigned char * sk_t1 )
{
...
void PQCLEAN_PQOV25618472CLASSIC_HACKED_calculate_P3( unsigned char * P3, const unsigned char * P1 , const unsigned char * P2 , const unsigned char * sk_t1 )
{
...
void PQCLEAN_PQOV25618472CLASSIC_HACKED_ov_pkc_calculate_Q_from_F( cpk_t * Qs, const sk_t * Fs , const sk_t * Ts )
{
  PQCLEAN_PQOV25618472CLASSIC_HACKED_calculate_P3( Qs->P3 , Fs->P1 , Fs->L , Ts->t1 );
}
