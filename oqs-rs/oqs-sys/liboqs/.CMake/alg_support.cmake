...
option(OQS_ENABLE_SIG_PQOV "Enable pqov algorithm family" ON)
cmake_dependent_option(OQS_ENABLE_SIG_pqov_16_160_64_classic "" ON "OQS_ENABLE_SIG_PQOV" OFF)
cmake_dependent_option(OQS_ENABLE_SIG_pqov_256_112_44_classic "" ON "OQS_ENABLE_SIG_PQOV" OFF)
cmake_dependent_option(OQS_ENABLE_SIG_pqov_256_184_72_classic "" ON "OQS_ENABLE_SIG_PQOV" OFF)
cmake_dependent_option(OQS_ENABLE_SIG_pqov_256_244_96_classic "" ON "OQS_ENABLE_SIG_PQOV" OFF)
...
cmake_dependent_option(OQS_ENABLE_SIG_sphincs_sha2_128f_robust "" ON "OQS_ENABLE_SIG_SPHINCS" OFF)
if(OQS_DIST_X86_64_BUILD OR (OQS_USE_AVX2_INSTRUCTIONS))
    cmake_dependent_option(OQS_ENABLE_SIG_sphincs_sha2_128f_robust_avx2 "" ON "OQS_ENABLE_SIG_sphincs_sha2_128f_robust" OFF)
endif()
...
cmake_dependent_option(OQS_ENABLE_SIG_sphincs_sha2_128s_robust "" ON "OQS_ENABLE_SIG_SPHINCS" OFF)
if(OQS_DIST_X86_64_BUILD OR (OQS_USE_AVX2_INSTRUCTIONS))
    cmake_dependent_option(OQS_ENABLE_SIG_sphincs_sha2_128s_robust_avx2 "" ON "OQS_ENABLE_SIG_sphincs_sha2_128s_robust" OFF)
endif()
...
cmake_dependent_option(OQS_ENABLE_SIG_sphincs_sha2_192f_robust "" ON "OQS_ENABLE_SIG_SPHINCS" OFF)
if(OQS_DIST_X86_64_BUILD OR (OQS_USE_AVX2_INSTRUCTIONS))
    cmake_dependent_option(OQS_ENABLE_SIG_sphincs_sha2_192f_robust_avx2 "" ON "OQS_ENABLE_SIG_sphincs_sha2_192f_robust" OFF)
endif()
...
cmake_dependent_option(OQS_ENABLE_SIG_sphincs_sha2_192s_robust "" ON "OQS_ENABLE_SIG_SPHINCS" OFF)
if(OQS_DIST_X86_64_BUILD OR (OQS_USE_AVX2_INSTRUCTIONS))
    cmake_dependent_option(OQS_ENABLE_SIG_sphincs_sha2_192s_robust_avx2 "" ON "OQS_ENABLE_SIG_sphincs_sha2_192s_robust" OFF)
endif()
...
cmake_dependent_option(OQS_ENABLE_SIG_sphincs_sha2_256f_robust "" ON "OQS_ENABLE_SIG_SPHINCS" OFF)
if(OQS_DIST_X86_64_BUILD OR (OQS_USE_AVX2_INSTRUCTIONS))
    cmake_dependent_option(OQS_ENABLE_SIG_sphincs_sha2_256f_robust_avx2 "" ON "OQS_ENABLE_SIG_sphincs_sha2_256f_robust" OFF)
endif()
...
cmake_dependent_option(OQS_ENABLE_SIG_sphincs_sha2_256s_robust "" ON "OQS_ENABLE_SIG_SPHINCS" OFF)
if(OQS_DIST_X86_64_BUILD OR (OQS_USE_AVX2_INSTRUCTIONS))
    cmake_dependent_option(OQS_ENABLE_SIG_sphincs_sha2_256s_robust_avx2 "" ON "OQS_ENABLE_SIG_sphincs_sha2_256s_robust" OFF)
endif()
...
cmake_dependent_option(OQS_ENABLE_SIG_sphincs_shake_128f_robust "" ON "OQS_ENABLE_SIG_SPHINCS" OFF)
if(OQS_DIST_X86_64_BUILD OR (OQS_USE_AVX2_INSTRUCTIONS))
    cmake_dependent_option(OQS_ENABLE_SIG_sphincs_shake_128f_robust_avx2 "" ON "OQS_ENABLE_SIG_sphincs_shake_128f_robust" OFF)
endif()

if(CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin")
if(OQS_DIST_ARM64_V8_BUILD OR (OQS_USE_ARM_NEON_INSTRUCTIONS AND OQS_USE_SHA3_INSTRUCTIONS))
    cmake_dependent_option(OQS_ENABLE_SIG_sphincs_shake_128f_robust_aarch64 "" ON "OQS_ENABLE_SIG_sphincs_shake_128f_robust" OFF)
endif()
endif()
...
if(CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin")
if(OQS_DIST_ARM64_V8_BUILD OR (OQS_USE_ARM_NEON_INSTRUCTIONS AND OQS_USE_SHA3_INSTRUCTIONS))
    cmake_dependent_option(OQS_ENABLE_SIG_sphincs_shake_128f_simple_aarch64 "" ON "OQS_ENABLE_SIG_sphincs_shake_128f_simple" OFF)
endif()
endif()

cmake_dependent_option(OQS_ENABLE_SIG_sphincs_shake_128s_robust "" ON "OQS_ENABLE_SIG_SPHINCS" OFF)
if(OQS_DIST_X86_64_BUILD OR (OQS_USE_AVX2_INSTRUCTIONS))
    cmake_dependent_option(OQS_ENABLE_SIG_sphincs_shake_128s_robust_avx2 "" ON "OQS_ENABLE_SIG_sphincs_shake_128s_robust" OFF)
endif()

if(CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin")
if(OQS_DIST_ARM64_V8_BUILD OR (OQS_USE_ARM_NEON_INSTRUCTIONS AND OQS_USE_SHA3_INSTRUCTIONS))
    cmake_dependent_option(OQS_ENABLE_SIG_sphincs_shake_128s_robust_aarch64 "" ON "OQS_ENABLE_SIG_sphincs_shake_128s_robust" OFF)
endif()
endif()
...
if(CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin")
if(OQS_DIST_ARM64_V8_BUILD OR (OQS_USE_ARM_NEON_INSTRUCTIONS AND OQS_USE_SHA3_INSTRUCTIONS))
    cmake_dependent_option(OQS_ENABLE_SIG_sphincs_shake_128s_simple_aarch64 "" ON "OQS_ENABLE_SIG_sphincs_shake_128s_simple" OFF)
endif()
endif()

cmake_dependent_option(OQS_ENABLE_SIG_sphincs_shake_192f_robust "" ON "OQS_ENABLE_SIG_SPHINCS" OFF)
if(OQS_DIST_X86_64_BUILD OR (OQS_USE_AVX2_INSTRUCTIONS))
    cmake_dependent_option(OQS_ENABLE_SIG_sphincs_shake_192f_robust_avx2 "" ON "OQS_ENABLE_SIG_sphincs_shake_192f_robust" OFF)
endif()

if(CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin")
if(OQS_DIST_ARM64_V8_BUILD OR (OQS_USE_ARM_NEON_INSTRUCTIONS AND OQS_USE_SHA3_INSTRUCTIONS))
    cmake_dependent_option(OQS_ENABLE_SIG_sphincs_shake_192f_robust_aarch64 "" ON "OQS_ENABLE_SIG_sphincs_shake_192f_robust" OFF)
endif()
endif()
...
if(CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin")
if(OQS_DIST_ARM64_V8_BUILD OR (OQS_USE_ARM_NEON_INSTRUCTIONS AND OQS_USE_SHA3_INSTRUCTIONS))
    cmake_dependent_option(OQS_ENABLE_SIG_sphincs_shake_192f_simple_aarch64 "" ON "OQS_ENABLE_SIG_sphincs_shake_192f_simple" OFF)
endif()
endif()

cmake_dependent_option(OQS_ENABLE_SIG_sphincs_shake_192s_robust "" ON "OQS_ENABLE_SIG_SPHINCS" OFF)
if(OQS_DIST_X86_64_BUILD OR (OQS_USE_AVX2_INSTRUCTIONS))
    cmake_dependent_option(OQS_ENABLE_SIG_sphincs_shake_192s_robust_avx2 "" ON "OQS_ENABLE_SIG_sphincs_shake_192s_robust" OFF)
endif()

if(CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin")
if(OQS_DIST_ARM64_V8_BUILD OR (OQS_USE_ARM_NEON_INSTRUCTIONS AND OQS_USE_SHA3_INSTRUCTIONS))
    cmake_dependent_option(OQS_ENABLE_SIG_sphincs_shake_192s_robust_aarch64 "" ON "OQS_ENABLE_SIG_sphincs_shake_192s_robust" OFF)
endif()
endif()
...
if(CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin")
if(OQS_DIST_ARM64_V8_BUILD OR (OQS_USE_ARM_NEON_INSTRUCTIONS AND OQS_USE_SHA3_INSTRUCTIONS))
    cmake_dependent_option(OQS_ENABLE_SIG_sphincs_shake_192s_simple_aarch64 "" ON "OQS_ENABLE_SIG_sphincs_shake_192s_simple" OFF)
endif()
endif()

cmake_dependent_option(OQS_ENABLE_SIG_sphincs_shake_256f_robust "" ON "OQS_ENABLE_SIG_SPHINCS" OFF)
if(OQS_DIST_X86_64_BUILD OR (OQS_USE_AVX2_INSTRUCTIONS))
    cmake_dependent_option(OQS_ENABLE_SIG_sphincs_shake_256f_robust_avx2 "" ON "OQS_ENABLE_SIG_sphincs_shake_256f_robust" OFF)
endif()

if(CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin")
if(OQS_DIST_ARM64_V8_BUILD OR (OQS_USE_ARM_NEON_INSTRUCTIONS AND OQS_USE_SHA3_INSTRUCTIONS))
    cmake_dependent_option(OQS_ENABLE_SIG_sphincs_shake_256f_robust_aarch64 "" ON "OQS_ENABLE_SIG_sphincs_shake_256f_robust" OFF)
endif()
endif()
...
if(CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin")
if(OQS_DIST_ARM64_V8_BUILD OR (OQS_USE_ARM_NEON_INSTRUCTIONS AND OQS_USE_SHA3_INSTRUCTIONS))
    cmake_dependent_option(OQS_ENABLE_SIG_sphincs_shake_256f_simple_aarch64 "" ON "OQS_ENABLE_SIG_sphincs_shake_256f_simple" OFF)
endif()
endif()

cmake_dependent_option(OQS_ENABLE_SIG_sphincs_shake_256s_robust "" ON "OQS_ENABLE_SIG_SPHINCS" OFF)
if(OQS_DIST_X86_64_BUILD OR (OQS_USE_AVX2_INSTRUCTIONS))
    cmake_dependent_option(OQS_ENABLE_SIG_sphincs_shake_256s_robust_avx2 "" ON "OQS_ENABLE_SIG_sphincs_shake_256s_robust" OFF)
endif()

if(CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin")
if(OQS_DIST_ARM64_V8_BUILD OR (OQS_USE_ARM_NEON_INSTRUCTIONS AND OQS_USE_SHA3_INSTRUCTIONS))
    cmake_dependent_option(OQS_ENABLE_SIG_sphincs_shake_256s_robust_aarch64 "" ON "OQS_ENABLE_SIG_sphincs_shake_256s_robust" OFF)
endif()
endif()
...
if(CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin")
if(OQS_DIST_ARM64_V8_BUILD OR (OQS_USE_ARM_NEON_INSTRUCTIONS AND OQS_USE_SHA3_INSTRUCTIONS))
    cmake_dependent_option(OQS_ENABLE_SIG_sphincs_shake_256s_simple_aarch64 "" ON "OQS_ENABLE_SIG_sphincs_shake_256s_simple" OFF)
endif()
endif()
